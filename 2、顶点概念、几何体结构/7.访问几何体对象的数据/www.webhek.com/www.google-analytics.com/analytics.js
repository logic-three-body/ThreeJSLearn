            ...
            if (e) {
                ...
                if ("auto" != ca) zc(c, e, g, ca, k, d, l) && (hc = !0);
                    ...
                    for (var w = id(), Ce = 0; Ce < w.length; Ce++)
                        if (ca =
                            w[Ce], a.data.set(W, ca), e = nd(a, b), zc(c, e, g, ca, k, d, l)) {
                            hc = !0;
                            return
                        }
                    a.data.set(W, "auto")
            ...
            if (a.get(Hd)) {
                ...
                if (c || e || ca || l)
                    if (c && e && J(36), a.get(bc) || ye(a.get(Kd)) || g) {
                        ...
                        ca ? (J(82), a.data.set(ce, ca), d.gclsrc && a.data.set(ie, d.gclsrc)) : l && (e = l.split(".")) && 2 === e.length && (J(37), a.data.set(ce,
                            e[0]), a.data.set(fe, e[1]));
                        ...
                        if (c) b: if (d = c.indexOf("."), -1 == d) J(22);
                                ...
                                J(11);
                                a.data.set(Q, d);
                                if (c = be("_gac", !!a.get(cc))) c = c.split("."), "1" != c[0] || 4 != c.length ?
                                    J(72) : ke(c[3], c[1]) ? J(71) : (a.data.set(ce, c[3]), a.data.set(fe, c[2]), J(70))
                            }
                    } else J(21)
            }
